...
class RenderRepo extends React.Component {
	...
	openIssue = () => {
		return (
			<div>
				<div className="d-flex align-items-end justify-content-between w-100 mb-4">
					<Link to="/"><p style={{ color: "#7546fe", fontWeight: 'bold', margin: 0 }}>Go back {this.props.fullName}</p></Link>
