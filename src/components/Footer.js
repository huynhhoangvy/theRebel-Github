...
class Footer extends React.Component {
  render() {
    return (
      <footer>
        <div
          className="footer container-lg width-full px-3"
          role="contentinfo"
          style={{ display: "flex", justifyContent: "space-between" }}
        >
          <div
            className="position-relative pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light w-100"
            style={{ display: "flex", justifyContent: "space-around" }}
          >
            <ul className="d-flex flex-wrap" style={{ listStyleType: "none" }}>
              <li className="mr-3">
                © 2019{" "}
                <span title="3.05615s from unicorn-7774cd9449-t74xz">
                  GitHub
                </span>
                , Inc.
              </li>
